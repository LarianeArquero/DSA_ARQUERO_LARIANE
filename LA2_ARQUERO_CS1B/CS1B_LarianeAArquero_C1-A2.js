...
console.log(a + b + c + Number(d) + e);

// compare the variables of d and e
console.log(Number(d) > e)//It's d is greater than e
console.log(Number(d) < e)//It's d is lesser than e
console.log(Number(d) >= e)//It's d is greater than or equal to e
console.log(Number(d) <= e)//It's d is lesser than or equal to e
console.log(Number(d)=== e)//It's d is strict equality to e

//subtract all the variables that we declared
let subraction = (a - b - c - Number(d) - e);
